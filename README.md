...
- **4,062개 단어 / 4,200개 뜻 / 8,400개 예문**. 기존 1,200개 뜻에 새 단어·뜻 3,000개를 추가했습니다. 확장팩의 일부 정의·한국어 힌트는 공개 사전 자료를 편집했으며, 공통 문장 틀을 사용한 예문이 포함됩니다. [출처·이용 조건·난이도 기준](data/ATTRIBUTION.md)을 참고하세요.
...
- `data/advanced.json`
- `data/expansion-beginner.json`
- `data/expansion-intermediate.json`
- `data/expansion-advanced.json`
